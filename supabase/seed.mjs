...
async function seedBrands() {
  const rows = [
    // ── Giyim ────────────────────────────────────────────────────────────────
    {
      ...
      category: 'giyim',
      style_tags: ['klasik', 'romantik'],
      onboarding_priority: 92,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['minimal', 'klasik'],
      onboarding_priority: 85,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['minimal', 'klasik', 'romantik'],
      onboarding_priority: 88,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['romantik', 'bohem'],
      onboarding_priority: 82,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['klasik', 'romantik', 'preppy'],
      onboarding_priority: 94,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['klasik', 'preppy'],
      onboarding_priority: 86,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'giyim',
      style_tags: ['romantik', 'bohem', 'minimal'],
      onboarding_priority: 88,
      cover_url: COVERS.giyim,
    ...
    },
    {
      ...
      category: 'çanta',
      style_tags: ['klasik', 'minimal'],
      onboarding_priority: 96,
      cover_url: COVERS.canta,
    ...
    },
    {
      ...
      category: 'güzellik',
      style_tags: ['bohem', 'romantik'],
      onboarding_priority: 77,
      cover_url: COVERS.guzellik,
    ...
    },
    {
      ...
      category: 'gıda',
      style_tags: ['klasik', 'bohem'],
      onboarding_priority: 74,
      cover_url: COVERS.gida,
