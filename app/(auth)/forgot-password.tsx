...
const styles = StyleSheet.create({
  ...
  logo: { fontFamily: Fonts.ui, fontSize: 11, color: Colors.gold3, letterSpacing: 5 },
  title: { fontFamily: Fonts.editorial, fontSize: 44, color: Colors.text1, lineHeight: 46 },
  subtitle: { fontFamily: Fonts.uiLight, fontSize: 15, color: Colors.text3, lineHeight: 22 },
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface2, borderRadius: 14, borderWidth: 0.5, borderColor: Colors.border2, paddingHorizontal: 16, height: 54, marginBottom: 16 },
  inputFocused: { borderColor: Colors.borderGold },
  inputIcon: { marginRight: 12 },
  input: { fontFamily: Fonts.uiLight, flex: 1, fontSize: 15, color: Colors.text1, height: '100%' },
  error: { fontFamily: Fonts.uiLight, fontSize: 13, color: Colors.error, marginBottom: 12, textAlign: 'center' },
  btn: { marginTop: 8 },
  successContainer: { flex: 1, alignItems: 'center', paddingTop: 80, gap: 16 },
  successIcon: { marginBottom: 8 },
  successTitle: { fontFamily: Fonts.editorial, fontSize: 32, color: Colors.text1 },
  successBody: { fontFamily: Fonts.uiLight, fontSize: 15, color: Colors.text3, textAlign: 'center', lineHeight: 22 },
  successEmail: { fontFamily: Fonts.uiMedium, color: Colors.text1 },
  backLink: { alignItems: 'center', paddingVertical: 20 },
  backLinkText: { fontFamily: Fonts.uiMedium, fontSize: 13, color: Colors.gold3, letterSpacing: 0.5 },
});
